...
export const checkDuplicateId = async (memberId) => {
    try {
        const response = await AuthApi.get(`/api/v1/auth/check-id`, {
            params: { memberId }
        });
        console.log("Check Duplicate Response:", response.data);  // response.data를 출력
