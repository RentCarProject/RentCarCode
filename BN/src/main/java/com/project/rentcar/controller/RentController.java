...
public class RentController {
    ...
    public ResponseEntity<String> RentDayDelay(@PathVariable("rentId") Long rentId, @RequestBody RentDto rentDto) {
    ...
    public ResponseEntity<List<RentDto>> getRentListByMember(Authentication authentication) {
        String memberId = authentication.getName();
        List<RentDto> rentList = rentServiceImpl.rentListByMember(memberId);
